    ...
    (set) => ({
      ...
      fetchAvailableExams: async () => {
        ...
        try {
          ...
          set({ error: error.message || 'Failed to fetch exams', isLoading: false });
        }
      },
      ...
      fetchExamById: async (id: string) => {
        ...
        try {
          ...
          set({ error: error.message || 'Failed to fetch exam', isLoading: false });
        }
      },
      ...
      startExam: async (id: string) => {
        ...
        try {
          ...
          set({ error: error.message || 'Failed to start exam', isLoading: false });
        }
      },
      ...
      completeExam: async (id: string) => {
        ...
        try {
          ...
          set({ error: error.message || 'Failed to complete exam', isLoading: false });
        }
      },
